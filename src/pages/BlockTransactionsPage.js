  ...
  return (
    <div className="addressDataContainer">
      <div className="addressDataTitle">
        ...
        <br />
        {blockTxs != null ? (
          <h3>A total of {blockTxs.length} transactions found</h3>
        ) : null}
      </div>
                  ...
                  return (
                    <tr className="tabledata" key={index}>
                      <td className="td-left-padding">
                        <span onClick={(e) => goToTransaction(data.txHash, e)}>
                          {data.txHash.substr(0, 20)}...
                        </span>
                      </td>
                      <td className="td-center">
                        <span onClick={(e) => goToBlock(data.blockNumber, e)}>
                          {data.blockNumber}
                        </span>
                      </td>
                      ...
                      <td className="td-center">
                        <span
                          onClick={(e) => goToFromAddress(data.fromAddress, e)}
                        >
                      ...
                      <td className="td-center">
                        <span onClick={(e) => goToToAddress(data.toAddress, e)}>
                          {data.toAddress.substr(0, 20)}...
                        </span>
                      </td>
                      <td className="td-right">
                        {parseInt(data.value, 16) / 10 ** 18} SC
                      </td>
                    </tr>
                  );
                })
