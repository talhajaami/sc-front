...
const Main = () => {
  ...
  const parseAddressAndTxn = (input) => {
    if (input.length > 0) return input.slice(0, 6) + "..." + input.slice(-6);
  };
          ...
          <div className="blockInfoSection1">
            ...
            <div className="block-col2">
              <div className="block-col2-row1">
                <h1>Transactions</h1>
                {totalTxsNum != null ? (
                  <h3 style={{ color: "white" }}>{totalTxsNum}</h3>
                ) : null}
              </div>
          ...
          <div className="blockInfoSection2">
            ...
            <div className="block-col3">
              <div className="block-col3-row1">
                <h1>SC Transactions History</h1>
              </div>
              <div className="block-col3-row2">
                {chartWeeklyTxsByDate != null ? (
                  <Chart
                    style={{ color: "white" }}
                    chartDate={chartWeeklyTxsByDate}
                  />
                ) : null}
              </div>
            </div>
                  ...
                  <div className="card-contents" key={index}>
                    <div className="card-contents-item">
                      ...
                      <div className="card-contents-item-col2">
                        ...
                        <div
                          className="card-contents-item-col2-row2"
                          style={{ color: "white" }}
                        >
                      ...
                      <div className="card-contents-item-col3">
                        <div className="card-contents-item-col3-row1">
                          ...
                          >
                            {parseAddressAndTxn(datas.blockhash)}
                        ...
                        <div className="card-contents-item-col3-row2">
                          <span
                            style={{ color: "white" }}
                            onClick={(e) => goToTxs(datas.blocknumber, e)}
                          >
                    ...
                    <div className="card-contents-item">
                      ...
                      <div className="card-contents-item-col2">
                        <div className="card-contents-item-col2-row1">
                          <span
                            style={{ color: "yellow" }}
                            onClick={(e) => goToTxHash(datas.txHash, e)}
                          >
                      ...
                      <div className="card-contents-item-col2-sapcebetween">
                        <div className="card-contents-item-col3">
                          <div
                            className="card-contents-item-col3-row1"
                            style={{ color: "yellow" }}
                          >
                            From :{" "}
                            <span
                            ...
                            >
                              {parseAddressAndTxn(datas.fromAddress)}
                            </span>
                          </div>
                          <div
                            className="card-contents-item-col3-row2"
                            style={{ color: "yellow" }}
                          >
                            To :{" "}
                            <span
