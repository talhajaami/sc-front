          ...
          <>
            <div className="blockDataInfo">
              <div className="blockData-row">
                ...
                <div className="blockData-col2">
                  <div className="flexbox">
                    <p style={{ color: "white" }}>{txInfo.hash}</p>
                    {copyCheckHash ? (
                ...
                <div className="blockData-col2">
                  <div className="confirm">
                    <span
                      style={{ color: "yellow" }}
                      onClick={(e) =>
                        goToBlock(parseInt(txInfo.blockNumber, 16), e)
                      }
                    >
              ...
              <div className="blockData-row">
                ...
                <div style={{ color: "white" }} className="blockData-col2">
                  {txInfo.blockHash}
                </div>
              </div>
              <div className="blockData-row">
              ...
              <div className="blockData-row">
                ...
                <div className="blockData-col2">
                  <div className="flexbox">
                    <span
                      style={{ color: "white" }}
                      onClick={(e) => goFromAddress(txInfo.from, e)}
                    >
                      {txInfo.from}
                    </span>
                    {copyCheckFrom ? (
                      ...
                      txInfo.to == null ? (
                        ...
                        <>
                          <div className="flexbox-flex">
                            ...
                            <span
                              style={{ color: "white" }}
                              onClick={(e) => goToAddress(txInfo.to, e)}
                            >
                              {txInfo.to}
                            </span>
                          </div>
              ...
              <div className="blockData-row">
                ...
                <div style={{ color: "white" }} className="blockData-col2">
                  {parseInt(txDbInfo.value, 16) / 10 ** 18} SC
                </div>
              </div>
                    ...
                    <>
                      <div className="inputData-table">
                        ...
                        txReceiptInfo.logs[0].topics[0] ==
                          ...
                          <div className="airdrop">20 SC Airdrop Completed</div>
                        ) : (
                          <table>
                            <thead>
                              <tr>
